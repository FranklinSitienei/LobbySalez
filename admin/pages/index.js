...
import BackgroundImage from '../public/assets/image.jpg'
...
export default function Home() {
  ...
  return (
    <div className={`${darkMode ? 'bg-black' : 'bg-white'} w-screen h-screen flex justify-center items-center`}>
      ...
      <form className={`flex flex-col rounded-lg shadow-md ${darkMode ? 'bg-blue-500' : 'bg-gray-100'} p-4 justify-center`} onSubmit={handleSignIn}>
        {/* Your form content */}
        ...
        <button type="submit" className={`hover:bg-black hover:text-white flex items-center gap-2 justify-center ${darkMode ? 'text-white' : 'text-black'} bg-gray-300`}>
